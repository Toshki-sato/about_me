...
<form action="" method="post" class="form">
            <dl class="a1">
                ...
                <textarea name="message" class="textarea" placeholder="<?php echo h($member['name']); ?>さん、今日のトレーニングを共有しましょう！（例：今日は胸トレをやったよ！！）" ><?php if(isset($message)){echo h ($message);} ?></textarea><input type="hidden" name="reply_post_id" value="<?php if(isset($_REQUEST['res'])){ echo h($_REQUEST['res']);}else{ echo '0'; }?>">
            </dl>
            <div>
	...
	<?php foreach ($posts as $post): ?>
            <div class="msg">
                ...
                <div class="msg-min1">
                    <p><?php echo $post['message']; //echo makeLink(h($post['message'])); ?></p>
